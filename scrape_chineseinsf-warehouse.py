...
with open('chineseinsfbay-warehouse.csv', 'a', encoding='utf-8', newline='') as writeFile:
    f = csv.writer(writeFile)
    f.writerows([row])
    
    # automate change to other pages, number 100 can be any other integers
    for i in range(0,1000,15):
        url = 'https://www.chineseinsfbay.com/f/page_viewforum/f_29/key_仓库/start_' + str(i) + '.html'
        pages.append(url)
